...
const DashboardPage = async () => {
  ...
  const cateogories = categoriesData?.categories || [];
       ...
       <div className="max-w-6xl mx-auto">
         <div className="mb-5">
            <h1 className="text-5xl md:text-7xl font-bold text-stone-900 mb-4 tracking-tight leading-tight">
                Fresh recipies, Served Daily 🔥
            </h1>
            <p className="text-xl text-stone-600 font-light max-w-2xl">
                Discover thousand of recipes from around the world. Cook, Create, and Savor.
            </p>
         </div>

         {/* Recipe of the day - Heero Section */}
          {recipeofTheDay && (
                         ...
                         <div className="grid md:grid-cols-2 gap-0">
                            ...
                            <div className="p-8 md:p-12 flex flex-col justify-center">
                                <div className="flex flex-wrap gap-2 mb-6">
                                    <Badge 
                                    variant="outline"
                                    className=" border-2 border-orange-600 text-orange-700 bg-or-50
                                     font-bold"
                                     >
         ...
         <section className="mb-24">
            <div className="mb-8">
                ...
                <p className="text-stone-600 text-lg font-light">
                    Find recipes that match your modd
                </p>
            </div>
