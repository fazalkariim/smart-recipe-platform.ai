      ...
      <div className='conatiner mx-auto max-w-5xl'> 
        ...
        {items.length > 0  && (
          <Link href={"/pantry/recipes"} className='block mb-8'>
            <div className='bg-linear-to-br from-green-600 to-emerald-500 text-white p-6 border-2
                ...
                <ChefHat className='w-8 h-8'/>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-green-100 text-sm font-light'>
                      Get Ai-Powered recipe suggestion from your {items.length}{" "}
                      ingredients
                    </p>
                  </div>
                ...
                {items.map((item)=>(
                  ...
                  {editingId === item.documentId ? (
                    <div className='space-y-3'>
                      ...
                      focus:border-orange-600 text-sm'
                    ...
                    <div className='flex gap-2'>
                     ...
                     {updating ? (
                      ...
                      onClick={cancelEdit}
                      disabled={updating}
                      className="flex-1 border-2 border-stone-900 hover:bg-stone-900 "
                      >
                        <X className='w-4 h-4'/>
                      </Button>
