...
export async function getRecipesByPantryIngredients(){
    ...
    const prompt = `You are a professional chef. Given these available ingredients: ${ingredients}
        Suggest 5 recipes that can be made primarily with these ingredients. It's okay if the recipes need 1-2 common pa
        ...
        [
         ...
         Rules:
         - matchPersentage should be 70-100% (how many listed ingredients are used)
         - missing Ingredients should be common items or optional additions
         - Sort by matchPersentage decending
         - Make recipies realistics and delicious
         `;
...
// helper function to fetch image from upslash
...
// get or generate to user collection (bookmark)
...
//save recipe to user collection (bookmark)
...
// remove recipe from user collection (unbookmark)
